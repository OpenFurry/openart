<html><!-- TODO i18n -->
    <head>
        <title><g:message code="openart.group.thread" default="Thread" /> - ${thread.title}</title>
    ...
    <body>
        <div class="breadcrumbs">
            ...
            <g:link controller="group" action="threads" id="${thread.group.slug}"><g:message code="openart.group.thread.plural" default="threads" /></g:link> &raquo;
            ${thread.title}
        </div>

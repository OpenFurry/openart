<html>
    <head>
        <title><g:message code="openart.event.views.create" default="Create event" /></title>
    ...
    <body>
        ...
        <g:form action="save" method="post">
            ...
            <table>
                <thead>
                    <tr>
                        <th colspan="2"><g:message code="openart.event.details" default="Event details" /></th>
                    </tr>
                </thead>
                <tbody>
                    <tr class="prop">
                        <th class="name"><g:message code="openart.event.title" default="Title" /></th>
                        <td class="value"><g:textField name="title" value="${instance?.title}" /></td>
                    </tr>
                    <tr class="prop">
                        <th class="name"><g:message code="openart.event.description" default="Description" />
                            <div class="message">
                    ...
                    <tr class="prop">
                        <th class="name"><g:message code="openart.event.location" default="Location" /></th>

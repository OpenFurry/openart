<head>
    ...
    <title><g:message code="openart.journal.view.create" default="New journal submission" /></title>
</head>
    ...
    <g:uploadForm action="saveJournal" method="post">
        <div class="dialog">
            <table>
                <thead>
                    <tr>
                        <th colspan="2"><g:message code="openart.journal.sectionTitle" default="Journal submission" /></th>
                    </tr>
                </thead>
                <tbody>
                    <tr class="prop">
                        <th class="name"><g:message code="openart.journal.title" default="Journal title" /></th>
                    ...
                    <tr class="prop">
                        ...
                        <td class="value ${hasErrors(bean: instance, field: 'rating', 'errors')}">
                            <g:each status="i" in="${grailsApplication.config.openart.ratings.repr}" var="rating">
                    ...
                    <tr class="prop">
                        <th class="name">
                            <g:message code="openart.journal.journal" default="Journal entry" />
                            <div class="message">

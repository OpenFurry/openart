<html>
    <head>
        <title><g:message code="openfurry.ticket.plural" default="Trouble Tickets" /></title>
    ...
    <body>
        <div class="verticalTabs">
            <ul class="nav">
                ...
                <li class="block ${params.type == '3' ? 'selected' : ''}"><a href="?type=0${params.status ? '&status=' + params.status : ''}"><g:message code="openfurry.issue.types.ToSViolation" default="ToS Violation" /></a></li>
                <li class="block ${params.type == '4' ? 'selected' : ''}"><a href="?type=1${params.status ? '&status=' + params.status : ''}"><g:message code="openfurry.issue.types.AUP Violation" default="AUP Violation" /></a></li>
                <li class="block ${params.type == '5' ? 'selected' : ''}"><a href="?type=2${params.status ? '&status=' + params.status : ''}"><g:message code="openfurry.issue.types.AccountIssue" default="Account Issue" /></a></li>
                <li class="block ${params.type == '6' ? 'selected' : ''}"><a href="?type=2${params.status ? '&status=' + params.status : ''}"><g:message code="openfurry.issue.types.Harrassment" default="Harrassment" /></a></li>
            </ul>
                ...
                <table class="list">
                    <thead>
                        <tr class="shadow">
                            ...
                            <th style="width: 10%" class="sortable${params.sort == 'votes' ? ' sorted' + (params.order == 'asc' ? ' asc' : ' desc') : ''}"><a href="?sort=votes&order=${params.order == 'asc' ? 'desc' : 'asc'}${params.type ? '&type=' + params.type : ''}${params.votes ? '&votes=' + params.votes : ''}"><g:message code="openfurry.comment.plural" default="Comments" /></a></th>
                        </tr>
                    </thead>
                    <tbody>

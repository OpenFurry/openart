                ...
                <tbody>
                    ...
                    <tr class="prop">
                        ...
                        <td class="value ${hasErrors(bean: instance, field: 'type', 'errors')}">
                            <select name="type">
                                <option value="3"${instance?.type == 3 ? ' selected="selected"':''}>${message(code: "openart.issue.type." + grailsApplication.config.openart.issue.repr[3], default: "ToS Violation")}</option>
                                <option value="4"${instance?.type == 4 ? ' selected="selected"':''}>${message(code: "openart.issue.type." + grailsApplication.config.openart.issue.repr[4], default: "AUP Violation")}</option>
                                <option value="5"${instance?.type == 5 ? ' selected="selected"':''}>${message(code: "openart.issue.type." + grailsApplication.config.openart.issue.repr[5], default: "Account Issue")}</option>
                                <option value="6"${instance?.type == 6 ? ' selected="selected"':''}>${message(code: "openart.issue.type." + grailsApplication.config.openart.issue.repr[6], default: "Harrassment")}</option>
                            </select>
                        </td>
                    </tr>
